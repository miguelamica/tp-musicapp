...
# FUNCIÓN PRINCIPAL
# ─────────────────────────────────────────
def run(uri="mongodb://localhost:27017/", db_name="soundwave"):
    """
    Puebla la base de datos con datos de ejemplo.
    Retorna el objeto `db` para que otras fases puedan reutilizar la conexión.
    """
    ...
    for i, uname in enumerate(user_names):
        ...
        play_history = [
            {
                "song_id": random.choice(all_song_ids),
    ...
    # Retornar db para reutilizar la conexión en otras fases
    return db
...
if __name__ == "__main__":
    print("─── Seed standalone ────────────────────────────────")
    db = run()
    print("────────────────────────────────────────────────────")
    print("Base de datos 'soundwave' lista.")
